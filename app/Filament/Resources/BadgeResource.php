...
class BadgeResource extends SecureResource
{
    ...
    protected static ?string $navigationLabel = 'الشارات';
    
    protected static ?string $modelLabel = 'شارة';
    
    protected static ?string $pluralModelLabel = 'الشارات';
        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('points_reward')
                    ...
                    ->numeric()
                    ->default(0),
                Forms\Components\TextInput::make('criteria_type')
                    ->required(),
